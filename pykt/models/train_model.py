...
def model_forward(model, data, rel=None):
    ...
    if model_name in ["dkt"]:
        y = model(c.long(), r.long()) # y=[256,199,265]
        y = (y * one_hot(cshft.long(), model.num_c)).sum(-1) # one_hot=[256,199,265]
...
def train_model(model, train_loader, valid_loader, num_epochs, opt, ckpt_path, test_loader=None,
    ...
    for i in range(1, num_epochs + 1):
        ...
        for data in train_loader:
            ...
            if model.model_name == "gikt" and train_step % 10 == 0:
